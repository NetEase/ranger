 ...
 */
public abstract class RangerMetastoreListenerPlugin {

  private static List<RangerMetastoreListenerPlugin> registry = new LinkedList<RangerMetastoreListenerPlugin>();

  public static void addToRegistry(RangerMetastoreListenerPlugin plugin) {
    registry.add(plugin);
  }

  public static List<RangerMetastoreListenerPlugin> getPlugins() {
    return registry;
  }
